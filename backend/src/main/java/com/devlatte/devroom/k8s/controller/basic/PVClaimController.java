...
public class PVClaimController extends K8sControllerBase{
    ...
    @GetMapping(value = "/pv-claim/all", produces = "application/json")
    public ResponseEntity<String> getPVClaimAll() {
        return handleResponse(pvClaimApi.getInfo("all", null));
    }

    @GetMapping(value = "/pv-claim/{label}/{value}", produces = "application/json")
    ...
    @PostMapping(value = "/pv-claim/create", produces = "application/json")
    ...
    @PostMapping(value = "/pv-claim/delete", produces = "application/json")
